...
The same applies for new area releases, which can be found in the [releases.json](/api/data/releases.json) file. These include only area releases themselves to avoid overcowding the chart.
